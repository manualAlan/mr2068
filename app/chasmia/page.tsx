...
export default function ChasmiaCampaign() {
  ...
  return <div className="amb68-root cha68-root cutter68">
    ...
    <main id="chasmia-main">
      ...
      <section className="cutter-about" id="about"><figure><img src="/images/chasmia/david-community.jpg" alt="David Cutter taking part in a community health check" loading="lazy"/></figure><div><p className="campaign-label">Meet David Cutter</p><h2>Ambitious for Chasmia.<br/><em>Grounded in what matters.</em></h2><p>David Cutter has represented Chasmia in Parliament since 2058 and has served as Prime Minister and Deputy Prime Minister. He knows that a national decision only counts when it makes life better where people live.</p><p>His case for 2068 begins with confidence in this region: its skilled workers, its farmers, its researchers and the people prepared to take a chance on a business of their own.</p><p>Standing for Moderate Reform within the Liberal-Conservative Alliance, David will press for investment that lasts, services that work and a fair chance to build a future here.</p><div className="cutter-signoff">David Cutter<span>MODERATE REFORM · CHASMIA</span></div><Link className="campaign-text-link" href="/team/#patrick">Meet the Alliance team <span aria-hidden="true">↗</span></Link></div></section>
