  ...
  return <div className="amb68-root cha68-root cutter68">
    ...
    <main id="chasmia-main">
      ...
      <section className="cutter-opening campaign-width">
        <div className="cutter-region-mark" style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:16,marginBottom:24}}><p className="campaign-label" style={{margin:0}}>The next Chasmia starts with us</p><img src="/images/chasmia/chasmian-flag.jpg" alt="Flag of Chasmia" width="54" height="36" style={{display:'block',width:54,height:36,maxWidth:54,objectFit:'contain',flexShrink:0}} loading="lazy"/></div>
